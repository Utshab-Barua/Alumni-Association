    ...
    return (
        <footer className="footer p-10 bg-black text-white">
            ...
            <nav>
                ...
                <Link className="link link-hover text-gray-300 mt-5">7-14, Nikunja Housing Society,South Khulshi, Chattogram <br />
                    Port City International University .</Link>
                <Link className="link link-hover text-gray-300 mt-2">+88 01851120791</Link>

                <Link className="link link-hover text-gray-300 mb-2">+88 01773225500</Link>
